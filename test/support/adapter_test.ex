# copy from depot, with some adjustments
defmodule DepotS3.AdapterTest do
  ...
  defp tests do
    quote do
      ...
      test "user can list files and folders", %{filesystem: filesystem} do
        ...
        :ok = Depot.write(filesystem, "test/test-1.txt", "Hello World")
  ...
  defmacro adapter_test(block) do
    quote do
      describe "common adapter tests" do
        ...
        import DepotS3.AdapterTest, only: [in_list: 2]
        unquote(tests())
      end
    end
  end
